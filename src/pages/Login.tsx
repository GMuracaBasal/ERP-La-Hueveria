...
import { BasalLogo } from '../components/BasalLogo';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-brand-cream flex flex-col py-12 px-4 sm:px-6 lg:px-8">
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="mt-10 flex justify-center">
          <div className="bg-white rounded-lg px-6 py-3 border border-brand-border shadow-sm">
            <BasalLogo size="lg" />
          </div>
        </div>
      </div>
